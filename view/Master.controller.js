sap.ui.core.mvc.Controller.extend("au.com.bpse.view.Master", {
	...
	onRouteMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "au.com.bpse.view.Master2",
			targetViewType: "XML"
		});
		...
		this.getRouter().myNavToWithoutHash({
			currentView: this.getView(),
			targetViewName: "au.com.bpse.view.Welcome",
			targetViewType: "XML"
		});
	},
	...
	onSearch: function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [new sap.ui.model.Filter("Insplot", sap.ui.model.FilterOperator.Contains, searchString)];
		}
